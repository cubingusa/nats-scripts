...
Define("FridayMorningAssignmentsForStage",
       All(
         DoVolunteerAssignments(
           ...
           [Judges(10, _777), Scramblers(4, _777), Runners(5), Delegates(2)],
...
Define("FridayAfternoonAssignmentsForStage",
       All(
         DoVolunteerAssignments(
           ...
           [Judges(10, _444), Scramblers(4, _444), Runners(5), Delegates(2)],
           VolunteerScorers(_444, 2025-07-04)),
         DoVolunteerAssignments(
           _minx-r1, {1, String}, 2025-07-04,
           [Judges(10, _minx), Scramblers(4, _minx), Runners(5), Delegates(2)],
