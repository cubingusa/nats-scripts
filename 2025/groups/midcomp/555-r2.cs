...
AssignGroups(_555-r2, SemifinalAssignmentSets(_555-r2), DefaultScorers(2025-07-03))

"Potential Pyra conflicts"
Table(
    Sort(Persons(And(CompetingInRound(_555-r2),
                     CompetingIn(_pyram),
                     (EndTime(AssignedGroup(_pyram-r1) > 2025-07-03T17:20)))),
